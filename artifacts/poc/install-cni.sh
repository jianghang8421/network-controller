...
wget https://github.com/cnrancher/static-macvlan-cni/releases/download/$VERSION/static-macvlan-cni-amd64-$VERSION.tgz
sudo tar zxvf static-macvlan-cni-amd64-$VERSION.tgz -C /opt/cni/bin/

wget https://github.com/cnrancher/static-ipam/releases/download/$VERSION/static-ipam-amd64-$VERSION.tgz
