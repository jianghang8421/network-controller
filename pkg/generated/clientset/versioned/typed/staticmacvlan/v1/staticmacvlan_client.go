...
type StaticmacvlanV1Client struct {
	restClient rest.Interface
}
...
func NewForConfig(c *rest.Config) (*StaticmacvlanV1Client, error) {
	config := *c
	...
	return &StaticmacvlanV1Client{client}, nil
}

// NewForConfigOrDie creates a new StaticmacvlanV1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *StaticmacvlanV1Client {
...
// New creates a new StaticmacvlanV1Client for the given RESTClient.
func New(c rest.Interface) *StaticmacvlanV1Client {
	return &StaticmacvlanV1Client{c}
}
...
func (c *StaticmacvlanV1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
